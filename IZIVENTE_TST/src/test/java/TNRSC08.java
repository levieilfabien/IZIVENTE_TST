 ...
 */
public class TNRSC08 extends SC00Test {
...
public void accesIzivente() throws SeleniumException {
	...
	scenario8.setIdUniqueTestLab(54395);
	scenario8.setNomCasEssai("TNRSC08-" + getTime());
	scenario8.setDescriptif("TNRSC08 - CE - IZIVENTE_Editique Prêt étudiant différé total");
	scenario8.setNomTestLab("TNRSC08 - CE - IZIVENTE_Editique Prêt étudiant différé total");
	//scenario8.setNomTestPlan("TNRSC08 - IZIVENTE_Editique Prêt étudiant différé total");
    ...
    outil.setRepertoireRacine(scenario8.getRepertoireTelechargement());
    ...
    try {
		...
		scenario8.getTests().add(CT01Initialisation(scenario8, outil));
		scenario8.getTests().add(CT02OuvertureDossier(scenario8, outil));
		scenario8.getTests().add(CT03SaisieDossier(scenario8, outil));
		scenario8.getTests().add(CT04Participants(scenario8, outil));
		scenario8.getTests().add(CT05FinalisationInstruction(scenario8, outil));
...
/**
 * Partie du scenario8 regroupant la saisie, l'instruction et la validation d'un dossier crédit amortissable PP pour prêt étudiant différé totaldans IZIVENTE CE.
...
public CasEssaiIziventeBean CT03SaisieDossier(CasEssaiIziventeBean scenario, SeleniumOutils outil) throws SeleniumException {
	...
	outil.selectionner("ETUDIANT NON PART DIFF TOTAL", Cibles.SELECTEUR_OFFRE_CREDIT, false);
	outil.attendre(2);
