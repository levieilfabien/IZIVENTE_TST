 ...
 */
public class TNRSC04 extends SC00Test {
...
public CasEssaiIziventeBean CT01Initialisation(CasEssaiIziventeBean scenario4, SeleniumOutils outil) throws SeleniumException {
	...
	CT01.setIdUniqueTestLab(scenario4.getIdUniqueTestLab());
	CT01.setCheminTestLab(scenario4.getCheminTestLab());
	CT01.setNomTestLab(scenario4.getNomTestLab());
	CT01.setRepertoireTelechargement(scenario4.getRepertoireTelechargement());	
	//Gestion des steps
...
public CasEssaiIziventeBean CT02OuvertureDossier(CasEssaiIziventeBean scenario4, SeleniumOutils outil) throws SeleniumException {
	...
	//Information issues du scénario.
	CT02.setIdUniqueTestLab(scenario4.getIdUniqueTestLab());
	CT02.setCheminTestLab(scenario4.getCheminTestLab());
	CT02.setNomTestLab(scenario4.getNomTestLab());
	CT02.setRepertoireTelechargement(scenario4.getRepertoireTelechargement());
	//Gestion des steps
...
public CasEssaiIziventeBean CT03SaisieDossier(CasEssaiIziventeBean scenario4, SeleniumOutils outil) throws SeleniumException {
	...
	//Information issues du scénario.
	CT03.setIdUniqueTestLab(scenario4.getIdUniqueTestLab());
	CT03.setCheminTestLab(scenario4.getCheminTestLab());
	CT03.setNomTestLab(scenario4.getNomTestLab());
	CT03.setRepertoireTelechargement(scenario4.getRepertoireTelechargement());
	//Gestion des steps
...
public CasEssaiIziventeBean CT04Participants(CasEssaiIziventeBean scenario4, SeleniumOutils outil) throws SeleniumException {
	...
	//Information issues du scénario.
	CT04.setIdUniqueTestLab(scenario4.getIdUniqueTestLab());
	CT04.setCheminTestLab(scenario4.getCheminTestLab());
	CT04.setNomTestLab(scenario4.getNomTestLab());
	CT04.setRepertoireTelechargement(scenario4.getRepertoireTelechargement());
	//Gestion des steps
...
public CasEssaiIziventeBean CT05FinalisationInstruction(CasEssaiIziventeBean scenario4, SeleniumOutils outil) throws SeleniumException {
	...
	//Information issues du scénario.
	CT05.setIdUniqueTestLab(scenario4.getIdUniqueTestLab());
	CT05.setCheminTestLab(scenario4.getCheminTestLab());
	CT05.setNomTestLab(scenario4.getNomTestLab());
	CT05.setRepertoireTelechargement(scenario4.getRepertoireTelechargement());
	//Gestion des steps
