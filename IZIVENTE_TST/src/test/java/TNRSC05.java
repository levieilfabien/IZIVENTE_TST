...
public void accesIzivente() throws SeleniumException {
	...
	scenario5.setIdUniqueTestLab(54392);
	scenario5.setNomCasEssai("TNRSC05-" + getTime());
	scenario5.setDescriptif("TNRSC05 - CE - IZIVENTE_Prêt travaux echelonné différé partiel");
	scenario5.setNomTestLab("TNRSC05 - CE - IZIVENTE_Prêt travaux echelonné différé partiel");
	//scenario5.setNomTestPlan("TNRSC05 - IZIVENTE_Prêt travaux echelonné différé partiel");
    ...
    outil.setRepertoireRacine(scenario5.getRepertoireTelechargement());
    ...
    try {
		...
		scenario5.getTests().add(CT01Initialisation(scenario5, outil));
		scenario5.getTests().add(CT02OuvertureDossier(scenario5, outil));
		scenario5.getTests().add(CT03SaisieDossier(scenario5, outil));
		scenario5.getTests().add(CT04Participants(scenario5, outil));
		scenario5.getTests().add(CT05FinalisationInstruction(scenario5, outil));
...
/**
 * Partie du scenario5 regroupant la saisie, l'instruction et la validation d'un dossier crédit amortissable PP pour travaux echelonné différé partiel dans IZIVENTE CE.
...
public CasEssaiIziventeBean CT03SaisieDossier(CasEssaiIziventeBean scenario, SeleniumOutils outil) throws SeleniumException {
	...
	outil.selectionner("TRAVAUX DIFFERE 12MOIS PARTIEL", Cibles.SELECTEUR_OFFRE_CREDIT, false);
	outil.attendre(2);
